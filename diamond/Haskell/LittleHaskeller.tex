...
\newcommand{\success}{\textcolor{darkgreen}{$\blacksquare$} }
...
\newcommand{\ask}{\lhN}
\newcommand{\answer}{\lhA}
\newcommand{\askfirst}{\lhQ}
\newcommand{\stopasking}{\lhend}
\newcommand{\halt}{\stopasking\end{document}}
\newenvironment{qr}[1]{%
